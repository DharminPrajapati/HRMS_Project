...
namespace MVCProject.Api.Controllers.Configuration
{
    ...
    public class EmployeeController : BaseController
    {
        ...
        public ApiResponse GetAllEmployees(PagingParams employeeDetailsParams)
        {
            ...
            var emplist = (from d in this.entities.TblEmployee.AsEnumerable().Where(x => x.FirstName.Trim().ToLower().Contains(employeeDetailsParams.Search.Trim().ToLower()))
            ...
            return this.Response(Utilities.MessageTypes.Success, string.Empty, emplist);
