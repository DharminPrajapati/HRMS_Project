...
namespace MVCProject.Areas.Configuration
{
    ...
    public class ConfigurationAreaRegistration : AreaRegistration
    {
        ...
        private void RegisterBundles(BundleCollection bundles)
        {
            ...
            // Department 
            bundles.Add(new ScriptBundle("~/bundles/Configuration/Department")
            ...
            // SalaryConfig 
            bundles.Add(new ScriptBundle("~/bundles/Configuration/Salary")
                .Include("~/Areas/Configuration/Scripts/angular/services/SalaryConfigService.js")
                .Include("~/Areas/Configuration/Scripts/angular/controllers/SalaryConfigCtrl.js"));
            // UserMaster
            ...
            // CompanyMaster
            bundles.Add(new ScriptBundle("~/bundles/Configuration/CompanyMaster")
