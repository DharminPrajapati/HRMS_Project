    ...
    .controller('uiCalendarCtrl', ['$scope',
        '$locale', function (
            ...
            this.eventFingerprint = function (e) {
                ...
                var StartAt = moment.isMoment(e.StartAt) ? e.StartAt.unix() : (e.StartAt ? moment(e.StartAt).unix() : '');
                var EndAt = moment.isMoment(e.EndAt) ? e.EndAt.unix() : (e.EndAt ? moment(e.EndAt).unix() : '');

                // This extracts all the information we need from the event. http://jsperf.com/angular-calendar-events-fingerprint/3
                return "" + e._id + (e.id || '') + (e.Title || '') + (e.url || '') + StartAt + EndAt +
                    (e.IsallDay || '') + (e.className || '') + extraSignature;
            };
